  ...
  <div id="container">
		...
		<div id="top" >
     	...
     	<div id="right">
				...
				<div class="box">
					<div class="title">
						<center>INGRESO DE PROGRAMA</center> 
						<span class="hide"></span>
					</div>
					<div class="content">
                   <?php  //total de Tipo de esc
							include("../../Clases/clsPrograma.php");
							$clsPrograma= new clsPrograma;
							$registro=$clsPrograma->fncProgramaTotal();
					?>
						<form name="frmIngresar" action="agrPro.php" id="frmIngresar" method="post" class="valid">
						<?php
							$Nro = (int)$registro[0] + 1;
						?> 
							<div class="row">
								<label>Codigo : </label>
								<div class="right"><input name="CodPro" type="text" id="CodPro" size="10" value="<?php echo $Nro ?>" disabled="disabled"/></div>
							</div>
							<div class="row">
								<label>Programa (*):</label>
								<div class="right"><input name="txtCaja" type="text" id="txtCaja" size="55"  value=""  class="{validate:{required:true, messages:{required:'Por favor ingrese este campo'}}}" /></div>
							</div>
							
							<input type="hidden" value="<?php echo $Nro ?>" name="CodPro" id="CodPro">
							<div class="row">								 
								<div class="center">
									<center>
