		...
		<div id="top" >
			...
			<div id="menu">
				<ul> 
					...
					<li ><a href="registrar_enace.php">Registrar</a>
						 
				    </li> 
					<li >
						<a href="mant_enace.php">Mantenimiento</a>
...
$enlace=Conec_db();
	...
	if (isset($insertar) )
		{ 		
		//tipo de escritura
		include("../../Clases/clsTipoEscPub.php");
		$ClsTipoEscPub = new clsTipoEscPub;
		$TipoEsc=$ClsTipoEscPub->fncSelTipoEscPubNom($TipoEsc1);

		//Notario
		include("../../Clases/clsNotario.php");
		$ClsNotario = new clsNotario;
		$ANotario=$ClsNotario->fncSelNotNom($ANotario1);	 
		
		$Fecha=implode('-',array_reverse(explode('-',$Fecha)));
		//consulta de inserccion
		include("../../Clases/clsEscPub.php");
		$ClsEscPub = new ClsEscPub;
		$ClsEscPub->fncInsEscPub($NroEscP,$Protocolo,$Folio,strtoupper($OtorgadoP),strtoupper($AFavor),$TipoEsc[0],$ANotario[0],$Fecha,$NroFojas,$Tomo); 		
			 ...
			 <div id="right">
				...
				<div class="box">
					...
					<div class="content">
						...
						<form name="frmIngresar" action="registrar_enace.php" id="frmIngresar" method="post" class="valid" enctype="multipart/form-data">
